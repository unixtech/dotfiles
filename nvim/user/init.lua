return {
  ...
  vim.api.nvim_create_user_command("DiagnosticsDisable", function() vim.diagnostic.disable() end, {}),
  vim.api.nvim_create_autocmd("VimEnter", {
    command = "DiagnosticsDisable",
  }),
  -- vim.api.nvim_create_autocmd("BufEnter", {
  --   command = "DiagnosticsToggle",
  -- }),
  --
  ...
  --- Supposed Heirline configuration
